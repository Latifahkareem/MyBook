...
session_start() ; 
 //error_reporting(0);				
if(!(isset($_SESSION["CurrentUserId"]) || $_SESSION["CurrentUserId"]!=''||isset($_SESSION["username"]) || $_SESSION["username"]!=''|| $_SESSION["user_type_id"] != 3  ))
{
...
<div id="wrapper" > 
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php">Teacher Control Panel</a> </div>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse" >
      <ul class="nav navbar-nav side-nav" >
        ...
        <li> <a href="users.php"><i class="fa fa-fw fa-user"></i> My Profile</a> </li>
